<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <label>
                <p>
                <h5>Limpieza<img src="https://cdn-icons-png.flaticon.com/128/3081/3081849.png" width="30" height="35">
            ...
            <label>
                <p>
                <h5>Comunicacion<img src="https://cdn-icons-png.flaticon.com/128/1427/1427796.png" width="30"
                        height="35">
                    <label><input type="checkbox" value="val" name="name2"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3">
                </h5>
                </p>
            </label></br>
            ...
            <label>
                <p>
                <h5>Ubicacion<img src="https://cdn-icons-png.flaticon.com/128/535/535239.png" width="30" height="35">
                    <label><input type="checkbox" value="val" name="name2"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
            ...
            <label>
                <p>
                <h5>Calidad-Precio <img src="https://cdn-icons-png.flaticon.com/512/8552/8552434.png" width="35"
                        height="35">
                    <label><input type="checkbox" value="val" name="name2"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
            ...
            <label>
                <p>
                <h5>Veracidad <img src="https://cdn-icons-png.flaticon.com/128/7356/7356144.png" width="30" height="35">
                    <label><input type="checkbox" value="val" name="name2"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                    <label><input type="checkbox" value="val" name="name3"></label>
                ...
                <h4> ¿Recomendarias a este lugar....? </h4></br>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1"
                        value="option1">
                    <label class="form-check-label" for="inlineRadio1">
                        <img src="https://cdn-icons-png.flaticon.com/512/717/717415.png" width="30" height="40">
                    </label>
                </div>
                <div class="form-check form-check-inline">
